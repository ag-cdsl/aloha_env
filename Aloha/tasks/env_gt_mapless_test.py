...
class AlphaBaseEnv(gym.Env):
    ...
    def __init__(
        ...
        create_prim(
                    ...
                    usd_path="/home/kit/.local/share/ov/pkg/isaac-sim-2023.1.1/standalone_examples/base_aloha_env/assets/scenes/sber_kitchen/sber_kitchen.usd",
                )
        # self.prim_path_table = "/World/table"
        # prims_utils.create_prim(
        #             prim_path=self.prim_path_table,
        #             prim_type="Xform",
        #             #translation=(0, 0.22, 0),
        #             usd_path="/home/kit/.local/share/ov/pkg/isaac-sim-2023.1.1/standalone_examples/base_aloha_env/Aloha/assets/scenes/airi_room_03/table.usd",
        #         )
        import omni.isaac.core.utils.stage as stage_utils
        from omni.isaac.core.articulations import Articulation
        self.table_usd_path = "/home/kit/.local/share/ov/pkg/isaac-sim-2023.1.1/standalone_examples/base_aloha_env/Aloha/assets/scenes/airi_room_03/table.usd"
        self.table_prim_path = "/table"

        stage_utils.add_reference_to_stage(self.table_usd_path, self.table_prim_path)
        self.table_prim = Articulation(self.table_prim_path , name="table")

        # obj = GeometryPrim(
        #     prim_path=self.prim_path_table,
        #     name="table",
        #     position= np.array([0.0, 0.0, 0.0]),
        #     orientation= np.array([0.0, 0.0, 0.0, 0.0]), # Shapenet model may be downward facing. Rotate in X direction by 90 degrees,
        #     usd_path="/home/kit/.local/share/ov/pkg/isaac-sim-2023.1.1/standalone_examples/base_aloha_env/Aloha/assets/scenes/airi_room_03/table.usd",
        #     visible=True,
        #     scale=[1,1,1], # Has to be scaled down to metres. Default usd units for these objects is cms
        #     collision=True
        # )
    ...
    def set_table_position(self):
        ...
        prim = dc.get_rigid_body(self.table_prim_path)
    ...
    def reset(self, *, seed: Optional[int] = None, options: Optional[dict] = None):
        ...
        if self.event == 0:
            ...
            x = 2.5
            table_orientation = get_quaternion_from_euler(0)
        elif self.event == 1:
            y =  3 * np.random.rand() + 2.5
            x = 0.4
            table_orientation = get_quaternion_from_euler(0)
            ...
            table_orientation = get_quaternion_from_euler(np.pi/2)
        self.table_prim.set_local_pose(translation=np.array([x, y, 0]), orientation=table_orientation)
